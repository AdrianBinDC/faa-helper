...
// This method will be automatically triggered any time the skill is invoked
app.launch(function(req, res) {

	var prompt = 'For delay information, tell me an Airport code.';

	// and it requires a response to be sent to the user
...
app.intent('airportinfo', {
	...
	function(req,res) {
		...
		var reprompt = 'Tell me an airport to get delay information.';

		if(_.isEmpty(airportCode)) {
			var prompt = 'I didn\'nt hear an airport code. Tell me an airport code.';
